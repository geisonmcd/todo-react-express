  ...
  render() {
    ...
    return (
      <div className="container">
        <h2>
          Are you sure you want to delete {this.state.taskData.task_name}?
        </h2>
        <div>
          {this.state.taskData.task_name} - {this.state.taskData.task_date}
        </div>
        <button onClick={this.confirmDelete} className="btn btn-danger">
          Yes!
        </button>
        <button onClick={this.runForCover} className="btn btn-default">
          No!
        </button>
      </div>
    );
